...
public class PantallaRegistro extends javax.swing.JDialog {
    ...
    private static PantallaRegistro pantallaRegistro;
     ...
     */
    public PantallaRegistro(java.awt.Frame parent, boolean modal, Cliente jugador, IFacadaDeNegocio facadaDeControl) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Maximo 10 caracteres");
    ...
    public static PantallaRegistro getInstacia(Frame parent, boolean modal, Cliente jugador, IFacadaDeNegocio facadaDeControl) {
        if (pantallaRegistro == null) {
            pantallaRegistro = new PantallaRegistro(parent, modal, jugador, facadaDeControl);
        }
